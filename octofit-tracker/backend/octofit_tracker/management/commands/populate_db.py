...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Activities
        Activity.objects.create(user=ironman.email, type='run', duration=30, date='2025-10-17')
        Activity.objects.create(user=batman.email, type='cycle', duration=45, date='2025-10-16')
